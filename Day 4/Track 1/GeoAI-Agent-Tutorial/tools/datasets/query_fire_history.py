...
# MTBS perimeter feature service (public ArcGIS REST, no auth required).
...
def query_fire_history(bbox: list[float], start_date: str, end_date: str) -> dict:
    """Query MTBS fire perimeters intersecting a bbox within a date range.

    bbox: [west, south, east, north]
    Signal rule (from reasoning.md): strong burn signal if any perimeter
    intersects bbox within the date range.
    """
